...
spark-install:
	wget https://dlcdn.apache.org/spark/spark-3.5.1/spark-3.5.1-bin-hadoop3.tgz  -P ~/spark
	tar xzfv ~/spark/spark-3.5.1-bin-hadoop3.tgz -C ~/spark/
	echo 'export SPARK_HOME="${HOME}/spark/spark-3.5.1-bin-hadoop3"' >> ~/.bashrc
	echo 'export PATH="${SPARK_HOME}/bin:${PATH}"' >> ~/.bashrc
	rm ~/spark/spark-3.5.1-bin-hadoop3.tgz
